...
(() => {
  ...
  function syncActiveAccount(){const accountId=activeAccountId();if(accountId)window.nexusPostNativeAction("setActiveAccount",{accountId});else window.nexusPostNativeAction("clearActiveAccount");}
