...
class NexusOtaWebManager(context: Context) {
    ...
    private fun downloadFile(url: String, output: File, expectedSize: Long): Long {
        ...
        try {
            ...
            if (length >= 0L && expectedSize >= 0L && length != expectedSize) {
    ...
    private fun open(url: String): HttpURLConnection {
        ...
        connection.setRequestProperty("User-Agent", "NexusNova-Android-OTA/1")
    ...
    private companion object {
        ...
        const val PREFS_NAME = "nexusnova_ota_web_v1"
