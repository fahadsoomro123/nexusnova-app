...
function createRoot() {
  ...
  root.innerHTML = `
    <div class="nnfl-top">
      ...
      <div class="nnfl-top-actions"><button type="button" class="nnfl-pak-mode" data-nnfl-pak-mode aria-pressed="false"><span class="nnfl-pak-flag" aria-hidden="true">🇵🇰</span><span class="nnfl-pak-copy"><b>PK</b><small>MODE</small></span></button><button type="button" class="nnfl-route-link" data-nnfl-brand><span>OPEN IN NOVA</span><small>BROWSER ↗</small></button></div>
    </div>
