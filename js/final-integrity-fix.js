...
(async () => {
  ...
  /* UI shell first so the user never sees the legacy five-tab dock flash in. */
  ...
  loadCritical({flag:'__nxUxSimplifyV1',marker:'data-nx-ux-simplify-v1',src:'./js/nexusnova-ux-simplify-v1.js?v=20260817-compact3',error:'NexusNova contextual navigation failed to load.'});
