...
(async () => {
  ...
  loadCritical({flag:'__nxProductivityDeskV1',marker:'data-nx-productivity-desk-v1',src:'./js/nexusnova-productivity-desk-v1.js?v=20260817-stable',error:'NexusNova offline Productivity Desk failed to load.'});
