...
(async () => {
  ...
  loadCritical({flag:'__nxUxSimplifyV1',marker:'data-nx-ux-simplify-v1',src:'./js/nexusnova-ux-simplify-v1.js?v=20260817-1013',error:'NexusNova UX simplify hotfix failed to load.'});
