...
try{
  ...
  await expect('Adjust text has real dark-surface contrast','const p=document.querySelector("[data-photo-sheet-panel=adjust]"),label=p?.querySelector(".nx-photo-field span"),sheet=document.querySelector(".nx-photo-sheet");if(!label||!sheet)return false;const c=getComputedStyle(label).color,b=getComputedStyle(sheet).backgroundColor;return c!==b&&c!=="rgba(0, 0, 0, 0)"&&c!=="rgb(255, 255, 255)"?true:c==="rgb(247, 249, 255)"||c==="rgb(217, 223, 235)";');
